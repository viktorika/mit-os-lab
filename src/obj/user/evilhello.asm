...
exit(void)
{
  ...
  80009a:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009d:	e8 64 05 00 00       	call   800606 <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  800132:	e8 5f 10 00 00       	call   801196 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ac:	00 
  8001ad:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  8001b4:	00 
  8001b5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001bc:	00 
  8001bd:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  8001c4:	e8 cd 0f 00 00       	call   801196 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ff:	00 
  800200:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  800207:	00 
  800208:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020f:	00 
  800210:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  800217:	e8 7a 0f 00 00       	call   801196 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800252:	00 
  800253:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  80025a:	00 
  80025b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800262:	00 
  800263:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  80026a:	e8 27 0f 00 00       	call   801196 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a5:	00 
  8002a6:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  8002ad:	00 
  8002ae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b5:	00 
  8002b6:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  8002bd:	e8 d4 0e 00 00       	call   801196 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f8:	00 
  8002f9:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  800300:	00 
  800301:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800308:	00 
  800309:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  800310:	e8 81 0e 00 00       	call   801196 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80034b:	00 
  80034c:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  800353:	00 
  800354:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80035b:	00 
  80035c:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  800363:	e8 2e 0e 00 00       	call   801196 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003c0:	00 
  8003c1:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  8003c8:	00 
  8003c9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003d0:	00 
  8003d1:	c7 04 24 c7 20 80 00 	movl   $0x8020c7,(%esp)
  8003d8:	e8 b9 0d 00 00       	call   801196 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800512:	eb 38                	jmp    80054c <dev_lookup+0x6b>
		if (devtab[i]->dev_id == dev_id) {
  800514:	39 05 20 30 80 00    	cmp    %eax,0x803020
  80051a:	74 dc                	je     8004f8 <dev_lookup+0x17>
  80051c:	39 05 3c 30 80 00    	cmp    %eax,0x80303c
  ...
  800535:	c7 04 24 d8 20 80 00 	movl   $0x8020d8,(%esp)
...
00800552 <fd_close>:
{
  ...
  8005c5:	e8 5a fc ff ff       	call   800224 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8006c3:	e8 09 fb ff ff       	call   8001d1 <sys_page_map>
  ...
  8006fe:	e8 ce fa ff ff       	call   8001d1 <sys_page_map>
...
err:
  ...
  800717:	e8 08 fb ff ff       	call   800224 <sys_page_unmap>
	sys_page_unmap(0, nva);
  80071c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800720:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800727:	e8 f8 fa ff ff       	call   800224 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80078b:	c7 04 24 19 21 80 00 	movl   $0x802119,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800873:	c7 04 24 35 21 80 00 	movl   $0x802135,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80092c:	c7 04 24 f8 20 80 00 	movl   $0x8020f8,(%esp)
...
00800b02 <devfile_read>:
{
  ...
  800b37:	c7 44 24 0c 52 21 80 	movl   $0x802152,0xc(%esp)
  800b3e:	00 
  800b3f:	c7 44 24 08 59 21 80 	movl   $0x802159,0x8(%esp)
  800b46:	00 
  800b47:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800b4e:	00 
  800b4f:	c7 04 24 6e 21 80 00 	movl   $0x80216e,(%esp)
  800b56:	e8 3b 06 00 00       	call   801196 <_panic>
	assert(r <= PGSIZE);
  800b5b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b60:	7e 24                	jle    800b86 <devfile_read+0x84>
  800b62:	c7 44 24 0c 79 21 80 	movl   $0x802179,0xc(%esp)
  800b69:	00 
  800b6a:	c7 44 24 08 59 21 80 	movl   $0x802159,0x8(%esp)
  800b71:	00 
  800b72:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800b79:	00 
  800b7a:	c7 04 24 6e 21 80 00 	movl   $0x80216e,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c48:	c7 44 24 04 85 21 80 	movl   $0x802185,0x4(%esp)
  800c4f:	00 
  ...
  800c6a:	00 00 00 
	stat->st_dev = &devpipe;
  800c6d:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  800c74:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  800c98:	e8 87 f5 ff ff       	call   800224 <sys_page_unmap>
...
00800cbb <_pipeisclosed>:
{
  ...
  800d0e:	c7 04 24 8c 21 80 00 	movl   $0x80218c,(%esp)
...
00800d24 <devpipe_write>:
{
  ...
  800d52:	75 54                	jne    800da8 <devpipe_write+0x84>
			sys_yield();
  800d54:	e8 05 f4 ff ff       	call   80015e <sys_yield>
...
00800db5 <devpipe_read>:
{
  ...
  800de7:	75 43                	jne    800e2c <devpipe_read+0x77>
			sys_yield();
  800de9:	e8 70 f3 ff ff       	call   80015e <sys_yield>
...
00800e39 <pipe>:
{
  ...
  800e6c:	e8 0c f3 ff ff       	call   80017d <sys_page_alloc>
  ...
  800ea6:	e8 d2 f2 ff ff       	call   80017d <sys_page_alloc>
  ...
  800ed5:	e8 a3 f2 ff ff       	call   80017d <sys_page_alloc>
  ...
  800f0e:	e8 be f2 ff ff       	call   8001d1 <sys_page_map>
  800f13:	89 c3                	mov    %eax,%ebx
  800f15:	85 c0                	test   %eax,%eax
  800f17:	78 52                	js     800f6b <pipe+0x132>
	fd0->fd_dev_id = devpipe.dev_id;
  800f19:	8b 15 20 30 80 00    	mov    0x803020,%edx
  ...
  800f2e:	8b 15 20 30 80 00    	mov    0x803020,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ff0:	c7 44 24 04 a4 21 80 	movl   $0x8021a4,0x4(%esp)
  800ff7:	00 
...
0080100a <devcons_write>:
{
  ...
  801056:	e8 55 f0 ff ff       	call   8000b0 <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801078 <devcons_read>:
{
  ...
  801089:	eb 28                	jmp    8010b3 <devcons_read+0x3b>
		sys_yield();
  80108b:	e8 ce f0 ff ff       	call   80015e <sys_yield>
	while ((c = sys_cgetc()) == 0)
  801090:	e8 39 f0 ff ff       	call   8000ce <sys_cgetc>
...
008010b5 <cputchar>:
{
  ...
  8010cf:	e8 dc ef ff ff       	call   8000b0 <sys_cputs>
}
  8010d4:	c9                   	leave  
  8010d5:	c3                   	ret    
...
0080113b <opencons>:
{
  ...
  801168:	e8 10 f0 ff ff       	call   80017d <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011a7:	e8 93 ef ff ff       	call   80013f <sys_getenvid>
  ...
  8011c2:	c7 04 24 b0 21 80 00 	movl   $0x8021b0,(%esp)
  ...
  8011d8:	e8 51 00 00 00       	call   80122e <vcprintf>
	cprintf("\n");
  8011dd:	c7 04 24 9d 21 80 00 	movl   $0x80219d,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801219:	e8 92 ee ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801282:	e8 29 ee ff ff       	call   8000b0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80138e:	0f be 80 d3 21 80 00 	movsbl 0x8021d3(%eax),%eax
...
00801424 <vprintfmt>:
{
  ...
  80156e:	c7 44 24 08 eb 21 80 	movl   $0x8021eb,0x8(%esp)
  801575:	00 
  ...
  80158e:	c7 44 24 08 6b 21 80 	movl   $0x80216b,0x8(%esp)
  801595:	00 
  ...
  8015bd:	ba e4 21 80 00       	mov    $0x8021e4,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ce0:	e8 ae e6 ff ff       	call   800393 <sys_ipc_recv>
	if(from_env_store)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d43:	75 05                	jne    801d4a <ipc_send+0x22>
			//失败到一定次数后放弃CPU
			sys_yield();
  801d45:	e8 14 e4 ff ff       	call   80015e <sys_yield>
	while(sys_ipc_try_send(to_env, val, pg, perm) < 0){
  ...
  801d5f:	e8 0c e6 ff ff       	call   800370 <sys_ipc_try_send>
