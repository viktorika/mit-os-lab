...
exit(void)
{
  ...
  800085:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800088:	e8 59 05 00 00       	call   8005e6 <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800105:	00 
  800106:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  80010d:	00 
  80010e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800115:	00 
  800116:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  80011d:	e8 54 10 00 00       	call   801176 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800197:	00 
  800198:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  80019f:	00 
  8001a0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001a7:	00 
  8001a8:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8001af:	e8 c2 0f 00 00       	call   801176 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ea:	00 
  8001eb:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  8001f2:	00 
  8001f3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fa:	00 
  8001fb:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  800202:	e8 6f 0f 00 00       	call   801176 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023d:	00 
  80023e:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  800245:	00 
  800246:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80024d:	00 
  80024e:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  800255:	e8 1c 0f 00 00       	call   801176 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800290:	00 
  800291:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  800298:	00 
  800299:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a0:	00 
  8002a1:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8002a8:	e8 c9 0e 00 00       	call   801176 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e3:	00 
  8002e4:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  8002eb:	00 
  8002ec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f3:	00 
  8002f4:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8002fb:	e8 76 0e 00 00       	call   801176 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800336:	00 
  800337:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  80033e:	00 
  80033f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800346:	00 
  800347:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  80034e:	e8 23 0e 00 00       	call   801176 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003ab:	00 
  8003ac:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  8003b3:	00 
  8003b4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bb:	00 
  8003bc:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8003c3:	e8 ae 0d 00 00       	call   801176 <_panic>
...
00800532 <fd_close>:
{
  ...
  8005a5:	e8 65 fc ff ff       	call   80020f <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8006a3:	e8 14 fb ff ff       	call   8001bc <sys_page_map>
  ...
  8006de:	e8 d9 fa ff ff       	call   8001bc <sys_page_map>
...
err:
  ...
  8006f7:	e8 13 fb ff ff       	call   80020f <sys_page_unmap>
	sys_page_unmap(0, nva);
  8006fc:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800700:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800707:	e8 03 fb ff ff       	call   80020f <sys_page_unmap>
	return r;
...
devpipe_close(struct Fd *fd)
{
  ...
  800c78:	e8 92 f5 ff ff       	call   80020f <sys_page_unmap>
  ...
  800c90:	e8 7a f5 ff ff       	call   80020f <sys_page_unmap>
}
...
00800d04 <devpipe_write>:
{
  ...
  800d32:	75 54                	jne    800d88 <devpipe_write+0x84>
			sys_yield();
  800d34:	e8 10 f4 ff ff       	call   800149 <sys_yield>
...
00800d95 <devpipe_read>:
{
  ...
  800dc7:	75 43                	jne    800e0c <devpipe_read+0x77>
			sys_yield();
  800dc9:	e8 7b f3 ff ff       	call   800149 <sys_yield>
...
00800e19 <pipe>:
{
  ...
  800e4c:	e8 17 f3 ff ff       	call   800168 <sys_page_alloc>
  ...
  800e86:	e8 dd f2 ff ff       	call   800168 <sys_page_alloc>
  ...
  800eb5:	e8 ae f2 ff ff       	call   800168 <sys_page_alloc>
  ...
  800eee:	e8 c9 f2 ff ff       	call   8001bc <sys_page_map>
...
00800fea <devcons_write>:
{
  ...
  801036:	e8 60 f0 ff ff       	call   80009b <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801058 <devcons_read>:
{
  ...
  801069:	eb 28                	jmp    801093 <devcons_read+0x3b>
		sys_yield();
  80106b:	e8 d9 f0 ff ff       	call   800149 <sys_yield>
	while ((c = sys_cgetc()) == 0)
  801070:	e8 44 f0 ff ff       	call   8000b9 <sys_cgetc>
...
00801095 <cputchar>:
{
  ...
  8010af:	e8 e7 ef ff ff       	call   80009b <sys_cputs>
}
  8010b4:	c9                   	leave  
  8010b5:	c3                   	ret    
...
0080111b <opencons>:
{
  ...
  801148:	e8 1b f0 ff ff       	call   800168 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801187:	e8 9e ef ff ff       	call   80012a <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8011f9:	e8 9d ee ff ff       	call   80009b <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801262:	e8 34 ee ff ff       	call   80009b <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801cc0:	e8 b9 e6 ff ff       	call   80037e <sys_ipc_recv>
	if(from_env_store)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d23:	75 05                	jne    801d2a <ipc_send+0x22>
			//失败到一定次数后放弃CPU
			sys_yield();
  801d25:	e8 1f e4 ff ff       	call   800149 <sys_yield>
	while(sys_ipc_try_send(to_env, val, pg, perm) < 0){
  ...
  801d3f:	e8 17 e6 ff ff       	call   80035b <sys_ipc_try_send>
