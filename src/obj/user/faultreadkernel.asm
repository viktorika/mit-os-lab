	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024e:	0f be 80 d1 20 80 00 	movsbl 0x8020d1(%eax),%eax
...
008002e4 <vprintfmt>:
{
  ...
  80036c:	ff 24 85 20 22 80 00 	jmp    *0x802220(,%eax,4)
  ...
  80044e:	c7 44 24 08 9f 24 80 	movl   $0x80249f,0x8(%esp)
  800455:	00 
  ...
  80047d:	ba e2 20 80 00       	mov    $0x8020e2,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf6:	00 
  800bf7:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800bfe:	00 
  800bff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c06:	00 
  800c07:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c88:	00 
  800c89:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800c90:	00 
  800c91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c98:	00 
  800c99:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cdb:	00 
  800cdc:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800ce3:	00 
  800ce4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ceb:	00 
  800cec:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d2e:	00 
  800d2f:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800d36:	00 
  800d37:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3e:	00 
  800d3f:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d81:	00 
  800d82:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800d89:	00 
  800d8a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d91:	00 
  800d92:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800dd4:	00 
  800dd5:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800ddc:	00 
  800ddd:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de4:	00 
  800de5:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e27:	00 
  800e28:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800e2f:	00 
  800e30:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e37:	00 
  800e38:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e9c:	00 
  800e9d:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800ea4:	00 
  800ea5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eac:	00 
  800ead:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801015:	c7 04 24 0c 24 80 00 	movl   $0x80240c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80126b:	c7 04 24 4d 24 80 00 	movl   $0x80244d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801353:	c7 04 24 69 24 80 00 	movl   $0x802469,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80140c:	c7 04 24 2c 24 80 00 	movl   $0x80242c,(%esp)
...
008015e2 <devfile_read>:
{
  ...
  801617:	c7 44 24 0c 86 24 80 	movl   $0x802486,0xc(%esp)
  80161e:	00 
  80161f:	c7 44 24 08 8d 24 80 	movl   $0x80248d,0x8(%esp)
  801626:	00 
  801627:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  80162e:	00 
  80162f:	c7 04 24 a2 24 80 00 	movl   $0x8024a2,(%esp)
  801636:	e8 3b 06 00 00       	call   801c76 <_panic>
	assert(r <= PGSIZE);
  80163b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801640:	7e 24                	jle    801666 <devfile_read+0x84>
  801642:	c7 44 24 0c ad 24 80 	movl   $0x8024ad,0xc(%esp)
  801649:	00 
  80164a:	c7 44 24 08 8d 24 80 	movl   $0x80248d,0x8(%esp)
  801651:	00 
  801652:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  801659:	00 
  80165a:	c7 04 24 a2 24 80 00 	movl   $0x8024a2,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801728:	c7 44 24 04 b9 24 80 	movl   $0x8024b9,0x4(%esp)
  80172f:	00 
...
0080179b <_pipeisclosed>:
{
  ...
  8017ee:	c7 04 24 c0 24 80 00 	movl   $0x8024c0,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ad0:	c7 44 24 04 d8 24 80 	movl   $0x8024d8,0x4(%esp)
  801ad7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ca2:	c7 04 24 e4 24 80 00 	movl   $0x8024e4,(%esp)
  ...
  801cb8:	e8 36 e4 ff ff       	call   8000f3 <vcprintf>
	cprintf("\n");
  801cbd:	c7 04 24 d1 24 80 00 	movl   $0x8024d1,(%esp)
