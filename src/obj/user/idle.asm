...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 80 	movl   $0x802080,0x803000
  800040:	20 80 00 
...
exit(void)
{
  ...
  800095:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800098:	e8 59 05 00 00       	call   8005f6 <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  80012d:	e8 54 10 00 00       	call   801186 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a7:	00 
  8001a8:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  8001af:	00 
  8001b0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b7:	00 
  8001b8:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  8001bf:	e8 c2 0f 00 00       	call   801186 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fa:	00 
  8001fb:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  800202:	00 
  800203:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020a:	00 
  80020b:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  800212:	e8 6f 0f 00 00       	call   801186 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024d:	00 
  80024e:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  800255:	00 
  800256:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025d:	00 
  80025e:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  800265:	e8 1c 0f 00 00       	call   801186 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a0:	00 
  8002a1:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  8002a8:	00 
  8002a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b0:	00 
  8002b1:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  8002b8:	e8 c9 0e 00 00       	call   801186 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f3:	00 
  8002f4:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  8002fb:	00 
  8002fc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800303:	00 
  800304:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  80030b:	e8 76 0e 00 00       	call   801186 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800346:	00 
  800347:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  80034e:	00 
  80034f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800356:	00 
  800357:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  80035e:	e8 23 0e 00 00       	call   801186 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003bb:	00 
  8003bc:	c7 44 24 08 8f 20 80 	movl   $0x80208f,0x8(%esp)
  8003c3:	00 
  8003c4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cb:	00 
  8003cc:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  8003d3:	e8 ae 0d 00 00       	call   801186 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800525:	c7 04 24 bc 20 80 00 	movl   $0x8020bc,(%esp)
...
00800542 <fd_close>:
{
  ...
  8005b5:	e8 65 fc ff ff       	call   80021f <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8006b3:	e8 14 fb ff ff       	call   8001cc <sys_page_map>
  ...
  8006ee:	e8 d9 fa ff ff       	call   8001cc <sys_page_map>
...
err:
  ...
  800707:	e8 13 fb ff ff       	call   80021f <sys_page_unmap>
	sys_page_unmap(0, nva);
  80070c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800710:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800717:	e8 03 fb ff ff       	call   80021f <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80077b:	c7 04 24 fd 20 80 00 	movl   $0x8020fd,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800863:	c7 04 24 19 21 80 00 	movl   $0x802119,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80091c:	c7 04 24 dc 20 80 00 	movl   $0x8020dc,(%esp)
...
00800af2 <devfile_read>:
{
  ...
  800b27:	c7 44 24 0c 36 21 80 	movl   $0x802136,0xc(%esp)
  800b2e:	00 
  800b2f:	c7 44 24 08 3d 21 80 	movl   $0x80213d,0x8(%esp)
  800b36:	00 
  800b37:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800b3e:	00 
  800b3f:	c7 04 24 52 21 80 00 	movl   $0x802152,(%esp)
  800b46:	e8 3b 06 00 00       	call   801186 <_panic>
	assert(r <= PGSIZE);
  800b4b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b50:	7e 24                	jle    800b76 <devfile_read+0x84>
  800b52:	c7 44 24 0c 5d 21 80 	movl   $0x80215d,0xc(%esp)
  800b59:	00 
  800b5a:	c7 44 24 08 3d 21 80 	movl   $0x80213d,0x8(%esp)
  800b61:	00 
  800b62:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800b69:	00 
  800b6a:	c7 04 24 52 21 80 00 	movl   $0x802152,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c38:	c7 44 24 04 69 21 80 	movl   $0x802169,0x4(%esp)
  800c3f:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800c88:	e8 92 f5 ff ff       	call   80021f <sys_page_unmap>
  ...
  800ca0:	e8 7a f5 ff ff       	call   80021f <sys_page_unmap>
}
...
00800cab <_pipeisclosed>:
{
  ...
  800cfe:	c7 04 24 70 21 80 00 	movl   $0x802170,(%esp)
...
00800d14 <devpipe_write>:
{
  ...
  800d42:	75 54                	jne    800d98 <devpipe_write+0x84>
			sys_yield();
  800d44:	e8 10 f4 ff ff       	call   800159 <sys_yield>
...
00800da5 <devpipe_read>:
{
  ...
  800dd7:	75 43                	jne    800e1c <devpipe_read+0x77>
			sys_yield();
  800dd9:	e8 7b f3 ff ff       	call   800159 <sys_yield>
...
00800e29 <pipe>:
{
  ...
  800e5c:	e8 17 f3 ff ff       	call   800178 <sys_page_alloc>
  ...
  800e96:	e8 dd f2 ff ff       	call   800178 <sys_page_alloc>
  ...
  800ec5:	e8 ae f2 ff ff       	call   800178 <sys_page_alloc>
  ...
  800efe:	e8 c9 f2 ff ff       	call   8001cc <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fe0:	c7 44 24 04 88 21 80 	movl   $0x802188,0x4(%esp)
  800fe7:	00 
...
00800ffa <devcons_write>:
{
  ...
  801046:	e8 60 f0 ff ff       	call   8000ab <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801068 <devcons_read>:
{
  ...
  801079:	eb 28                	jmp    8010a3 <devcons_read+0x3b>
		sys_yield();
  80107b:	e8 d9 f0 ff ff       	call   800159 <sys_yield>
	while ((c = sys_cgetc()) == 0)
  801080:	e8 44 f0 ff ff       	call   8000c9 <sys_cgetc>
...
008010a5 <cputchar>:
{
  ...
  8010bf:	e8 e7 ef ff ff       	call   8000ab <sys_cputs>
}
  8010c4:	c9                   	leave  
  8010c5:	c3                   	ret    
...
0080112b <opencons>:
{
  ...
  801158:	e8 1b f0 ff ff       	call   800178 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801197:	e8 9e ef ff ff       	call   80013a <sys_getenvid>
  ...
  8011b2:	c7 04 24 94 21 80 00 	movl   $0x802194,(%esp)
  ...
  8011c8:	e8 51 00 00 00       	call   80121e <vcprintf>
	cprintf("\n");
  8011cd:	c7 04 24 81 21 80 00 	movl   $0x802181,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801209:	e8 9d ee ff ff       	call   8000ab <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801272:	e8 34 ee ff ff       	call   8000ab <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80137e:	0f be 80 b7 21 80 00 	movsbl 0x8021b7(%eax),%eax
...
00801414 <vprintfmt>:
{
  ...
  80155e:	c7 44 24 08 cf 21 80 	movl   $0x8021cf,0x8(%esp)
  801565:	00 
  ...
  80157e:	c7 44 24 08 4f 21 80 	movl   $0x80214f,0x8(%esp)
  801585:	00 
  ...
  8015ad:	ba c8 21 80 00       	mov    $0x8021c8,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801cd0:	e8 b9 e6 ff ff       	call   80038e <sys_ipc_recv>
	if(from_env_store)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d33:	75 05                	jne    801d3a <ipc_send+0x22>
			//失败到一定次数后放弃CPU
			sys_yield();
  801d35:	e8 1f e4 ff ff       	call   800159 <sys_yield>
	while(sys_ipc_try_send(to_env, val, pg, perm) < 0){
  ...
  801d4f:	e8 17 e6 ff ff       	call   80036b <sys_ipc_try_send>
