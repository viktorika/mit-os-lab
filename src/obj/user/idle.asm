...
sys_env_destroy(envid_t envid)
{
  ...
  800110:	00 
  800111:	c7 44 24 08 6f 11 80 	movl   $0x80116f,0x8(%esp)
  800118:	00 
  800119:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800120:	00 
  800121:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a2:	00 
  8001a3:	c7 44 24 08 6f 11 80 	movl   $0x80116f,0x8(%esp)
  8001aa:	00 
  8001ab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b2:	00 
  8001b3:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f5:	00 
  8001f6:	c7 44 24 08 6f 11 80 	movl   $0x80116f,0x8(%esp)
  8001fd:	00 
  8001fe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800205:	00 
  800206:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800248:	00 
  800249:	c7 44 24 08 6f 11 80 	movl   $0x80116f,0x8(%esp)
  800250:	00 
  800251:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800258:	00 
  800259:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80029b:	00 
  80029c:	c7 44 24 08 6f 11 80 	movl   $0x80116f,0x8(%esp)
  8002a3:	00 
  8002a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002ab:	00 
  8002ac:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002ee:	00 
  8002ef:	c7 44 24 08 6f 11 80 	movl   $0x80116f,0x8(%esp)
  8002f6:	00 
  8002f7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002fe:	00 
  8002ff:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800363:	00 
  800364:	c7 44 24 08 6f 11 80 	movl   $0x80116f,0x8(%esp)
  80036b:	00 
  80036c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800373:	00 
  800374:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003b4:	c7 04 24 9c 11 80 00 	movl   $0x80119c,(%esp)
  ...
  8003ca:	e8 51 00 00 00       	call   800420 <vcprintf>
	cprintf("\n");
  8003cf:	c7 04 24 c0 11 80 00 	movl   $0x8011c0,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80045c:	e8 b3 01 00 00       	call   800614 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80057e:	0f be 80 c2 11 80 00 	movsbl 0x8011c2(%eax),%eax
...
00800614 <vprintfmt>:
{
  ...
  80075e:	c7 44 24 08 da 11 80 	movl   $0x8011da,0x8(%esp)
  800765:	00 
  ...
  80077e:	c7 44 24 08 e3 11 80 	movl   $0x8011e3,0x8(%esp)
  800785:	00 
  ...
  8007ad:	ba d3 11 80 00       	mov    $0x8011d3,%edx
