...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 2c             	sub    $0x2c,%esp
	...
	if ((who = fork()) != 0) {
  80003c:	e8 0a 10 00 00       	call   80104b <fork>
  ...
  80004a:	e8 6c 0c 00 00       	call   800cbb <sys_getenvid>
  80004f:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800053:	89 44 24 04          	mov    %eax,0x4(%esp)
  800057:	c7 04 24 20 17 80 00 	movl   $0x801720,(%esp)
  80005e:	e8 93 01 00 00       	call   8001f6 <cprintf>
		ipc_send(who, 0, 0, 0);
  ...
  800081:	e8 5a 12 00 00       	call   8012e0 <ipc_send>
	}
  ...
  80009c:	e8 e3 11 00 00       	call   801284 <ipc_recv>
  8000a1:	89 c3                	mov    %eax,%ebx
		cprintf("%x got %d from %x\n", sys_getenvid(), i, who);
  8000a3:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  8000a6:	e8 10 0c 00 00       	call   800cbb <sys_getenvid>
  8000ab:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8000af:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8000b3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8000b7:	c7 04 24 36 17 80 00 	movl   $0x801736,(%esp)
  8000be:	e8 33 01 00 00       	call   8001f6 <cprintf>
		if (i == 10)
  ...
  8000e5:	e8 f6 11 00 00       	call   8012e0 <ipc_send>
		if (i == 10)
...
libmain(int argc, char **argv)
{
  ...
  800105:	e8 b1 0b 00 00       	call   800cbb <sys_getenvid>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028c:	e8 ef 11 00 00       	call   801480 <__udivdi3>
  ...
  8002e5:	e8 c6 12 00 00       	call   8015b0 <__umoddi3>
  8002ea:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002ee:	0f be 80 53 17 80 00 	movsbl 0x801753(%eax),%eax
...
00800384 <vprintfmt>:
{
  ...
  80040c:	ff 24 85 20 18 80 00 	jmp    *0x801820(,%eax,4)
  ...
  8004ee:	c7 44 24 08 74 17 80 	movl   $0x801774,0x8(%esp)
  8004f5:	00 
  ...
  80051d:	ba 64 17 80 00       	mov    $0x801764,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c96:	00 
  800c97:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  800c9e:	00 
  800c9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca6:	00 
  800ca7:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
  800cae:	e8 bd 06 00 00       	call   801370 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d28:	00 
  800d29:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  800d30:	00 
  800d31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d38:	00 
  800d39:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
  800d40:	e8 2b 06 00 00       	call   801370 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d7b:	00 
  800d7c:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  800d83:	00 
  800d84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8b:	00 
  800d8c:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
  800d93:	e8 d8 05 00 00       	call   801370 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800dce:	00 
  800dcf:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  800dd6:	00 
  800dd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dde:	00 
  800ddf:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
  800de6:	e8 85 05 00 00       	call   801370 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e21:	00 
  800e22:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  800e29:	00 
  800e2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e31:	00 
  800e32:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
  800e39:	e8 32 05 00 00       	call   801370 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e74:	00 
  800e75:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  800e7c:	00 
  800e7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e84:	00 
  800e85:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
  800e8c:	e8 df 04 00 00       	call   801370 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ee9:	00 
  800eea:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  800ef1:	00 
  800ef2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ef9:	00 
  800efa:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
  800f01:	e8 6a 04 00 00       	call   801370 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800f52:	c7 44 24 08 d0 19 80 	movl   $0x8019d0,0x8(%esp)
  800f59:	00 
  800f5a:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800f61:	00 
  800f62:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  800f69:	e8 02 04 00 00       	call   801370 <_panic>
	// Hint:
  ...
  800f95:	c7 44 24 08 9a 1a 80 	movl   $0x801a9a,0x8(%esp)
  800f9c:	00 
  800f9d:	c7 44 24 04 29 00 00 	movl   $0x29,0x4(%esp)
  800fa4:	00 
  800fa5:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  800fac:	e8 bf 03 00 00       	call   801370 <_panic>
  ...
  800ff5:	c7 44 24 08 b8 1a 80 	movl   $0x801ab8,0x8(%esp)
  800ffc:	00 
  800ffd:	c7 44 24 04 2d 00 00 	movl   $0x2d,0x4(%esp)
  801004:	00 
  801005:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  80100c:	e8 5f 03 00 00       	call   801370 <_panic>
  ...
  801029:	c7 44 24 08 d4 1a 80 	movl   $0x801ad4,0x8(%esp)
  801030:	00 
  801031:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801038:	00 
  801039:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  801040:	e8 2b 03 00 00       	call   801370 <_panic>
}
...
fork(void)
{
  ...
  80105b:	e8 66 03 00 00       	call   8013c6 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  80106e:	c7 44 24 08 f2 1a 80 	movl   $0x801af2,0x8(%esp)
  801075:	00 
  801076:	c7 44 24 04 6e 00 00 	movl   $0x6e,0x4(%esp)
  80107d:	00 
  80107e:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  801085:	e8 e6 02 00 00       	call   801370 <_panic>
  ...
  801127:	c7 44 24 08 fc 19 80 	movl   $0x8019fc,0x8(%esp)
  80112e:	00 
  80112f:	c7 44 24 04 48 00 00 	movl   $0x48,0x4(%esp)
  801136:	00 
  801137:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  80113e:	e8 2d 02 00 00       	call   801370 <_panic>
  ...
  80116b:	c7 44 24 08 20 1a 80 	movl   $0x801a20,0x8(%esp)
  801172:	00 
  801173:	c7 44 24 04 4b 00 00 	movl   $0x4b,0x4(%esp)
  80117a:	00 
  80117b:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  801182:	e8 e9 01 00 00       	call   801370 <_panic>
  ...
  8011ab:	c7 44 24 08 4c 1a 80 	movl   $0x801a4c,0x8(%esp)
  8011b2:	00 
  8011b3:	c7 44 24 04 50 00 00 	movl   $0x50,0x4(%esp)
  8011ba:	00 
  8011bb:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  8011c2:	e8 a9 01 00 00       	call   801370 <_panic>
		for(addr = UTEXT; addr < USTACKTOP; addr+= PGSIZE){
  ...
  8011f8:	c7 44 24 08 0a 1b 80 	movl   $0x801b0a,0x8(%esp)
  8011ff:	00 
  801200:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801207:	00 
  801208:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  80120f:	e8 5c 01 00 00       	call   801370 <_panic>
		extern void _pgfault_upcall();
		sys_env_set_pgfault_upcall(envid, _pgfault_upcall);
  801214:	c7 44 24 04 4f 14 80 	movl   $0x80144f,0x4(%esp)
  80121b:	00 
  ...
  80123b:	c7 44 24 08 70 1a 80 	movl   $0x801a70,0x8(%esp)
  801242:	00 
  801243:	c7 44 24 04 7e 00 00 	movl   $0x7e,0x4(%esp)
  80124a:	00 
  80124b:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  801252:	e8 19 01 00 00       	call   801370 <_panic>
	}
	return envid;
}
...
sfork(void)
{
  ...
  801268:	c7 44 24 08 25 1b 80 	movl   $0x801b25,0x8(%esp)
  80126f:	00 
  801270:	c7 44 24 04 87 00 00 	movl   $0x87,0x4(%esp)
  801277:	00 
  801278:	c7 04 24 8f 1a 80 00 	movl   $0x801a8f,(%esp)
  80127f:	e8 ec 00 00 00       	call   801370 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801298:	e8 1f fc ff ff       	call   800ebc <sys_ipc_recv>
	if(from_env_store)
  80129d:	85 f6                	test   %esi,%esi
  80129f:	74 14                	je     8012b5 <ipc_recv+0x31>
		*from_env_store = (result<0?0:thisenv->env_ipc_from);
  8012a1:	ba 00 00 00 00       	mov    $0x0,%edx
  8012a6:	85 c0                	test   %eax,%eax
  8012a8:	78 09                	js     8012b3 <ipc_recv+0x2f>
  8012aa:	8b 15 04 20 80 00    	mov    0x802004,%edx
  8012b0:	8b 52 74             	mov    0x74(%edx),%edx
  8012b3:	89 16                	mov    %edx,(%esi)
	if(perm_store)
  8012b5:	85 db                	test   %ebx,%ebx
  8012b7:	74 14                	je     8012cd <ipc_recv+0x49>
		*perm_store = (result<0?0:thisenv->env_ipc_perm);
  8012b9:	ba 00 00 00 00       	mov    $0x0,%edx
  8012be:	85 c0                	test   %eax,%eax
  8012c0:	78 09                	js     8012cb <ipc_recv+0x47>
  8012c2:	8b 15 04 20 80 00    	mov    0x802004,%edx
  8012c8:	8b 52 78             	mov    0x78(%edx),%edx
  8012cb:	89 13                	mov    %edx,(%ebx)
	if(result < 0)
  8012cd:	85 c0                	test   %eax,%eax
  8012cf:	78 08                	js     8012d9 <ipc_recv+0x55>
		return result;
	return thisenv->env_ipc_value;
  8012d1:	a1 04 20 80 00       	mov    0x802004,%eax
  8012d6:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8012f4:	eb 0c                	jmp    801302 <ipc_send+0x22>
		failed_cnt++;
  8012f6:	83 c3 01             	add    $0x1,%ebx
		if(!(failed_cnt & 0xff))
  8012f9:	84 db                	test   %bl,%bl
  8012fb:	75 05                	jne    801302 <ipc_send+0x22>
			//失败到一定次数后放弃CPU
			sys_yield();
  8012fd:	e8 d8 f9 ff ff       	call   800cda <sys_yield>
	while(sys_ipc_try_send(to_env, val, pg, perm) < 0){
  801302:	8b 45 14             	mov    0x14(%ebp),%eax
  801305:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801309:	8b 45 10             	mov    0x10(%ebp),%eax
  80130c:	89 44 24 08          	mov    %eax,0x8(%esp)
  801310:	89 74 24 04          	mov    %esi,0x4(%esp)
  801314:	89 3c 24             	mov    %edi,(%esp)
  801317:	e8 7d fb ff ff       	call   800e99 <sys_ipc_try_send>
  80131c:	85 c0                	test   %eax,%eax
  80131e:	78 d6                	js     8012f6 <ipc_send+0x16>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  80132e:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801333:	39 c8                	cmp    %ecx,%eax
  801335:	74 17                	je     80134e <ipc_find_env+0x26>
	for (i = 0; i < NENV; i++)
  801337:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  80133c:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80133f:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801345:	8b 52 50             	mov    0x50(%edx),%edx
  801348:	39 ca                	cmp    %ecx,%edx
  80134a:	75 14                	jne    801360 <ipc_find_env+0x38>
  80134c:	eb 05                	jmp    801353 <ipc_find_env+0x2b>
	for (i = 0; i < NENV; i++)
  80134e:	b8 00 00 00 00       	mov    $0x0,%eax
			return envs[i].env_id;
  801353:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801356:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  80135b:	8b 40 40             	mov    0x40(%eax),%eax
  80135e:	eb 0e                	jmp    80136e <ipc_find_env+0x46>
	for (i = 0; i < NENV; i++)
  801360:	83 c0 01             	add    $0x1,%eax
  801363:	3d 00 04 00 00       	cmp    $0x400,%eax
  801368:	75 d2                	jne    80133c <ipc_find_env+0x14>
	return 0;
  80136a:	66 b8 00 00          	mov    $0x0,%ax
}
  80136e:	5d                   	pop    %ebp
  80136f:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801375:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  801378:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80137b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801381:	e8 35 f9 ff ff       	call   800cbb <sys_getenvid>
  801386:	8b 55 0c             	mov    0xc(%ebp),%edx
  801389:	89 54 24 10          	mov    %edx,0x10(%esp)
  80138d:	8b 55 08             	mov    0x8(%ebp),%edx
  801390:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801394:	89 74 24 08          	mov    %esi,0x8(%esp)
  801398:	89 44 24 04          	mov    %eax,0x4(%esp)
  80139c:	c7 04 24 3c 1b 80 00 	movl   $0x801b3c,(%esp)
  8013a3:	e8 4e ee ff ff       	call   8001f6 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8013a8:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8013ac:	8b 45 10             	mov    0x10(%ebp),%eax
  8013af:	89 04 24             	mov    %eax,(%esp)
  8013b2:	e8 de ed ff ff       	call   800195 <vcprintf>
	cprintf("\n");
  8013b7:	c7 04 24 47 17 80 00 	movl   $0x801747,(%esp)
  8013be:	e8 33 ee ff ff       	call   8001f6 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8013c3:	cc                   	int3   
  8013c4:	eb fd                	jmp    8013c3 <_panic+0x53>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8013cc:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  8013d3:	75 70                	jne    801445 <set_pgfault_handler+0x7f>
		// First time through!
		// LAB 4: Your code here.
		//第一次要分配页面给异常stack使用
		if(sys_page_alloc(0, (void *)(UXSTACKTOP - PGSIZE), PTE_P|PTE_U|PTE_W) < 0)
  8013d5:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  8013dc:	00 
  8013dd:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  8013e4:	ee 
  8013e5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8013ec:	e8 08 f9 ff ff       	call   800cf9 <sys_page_alloc>
  8013f1:	85 c0                	test   %eax,%eax
  8013f3:	79 1c                	jns    801411 <set_pgfault_handler+0x4b>
			panic("set_pgfault_handler: sys_page_alloc failed");
  8013f5:	c7 44 24 08 60 1b 80 	movl   $0x801b60,0x8(%esp)
  8013fc:	00 
  8013fd:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  801404:	00 
  801405:	c7 04 24 c4 1b 80 00 	movl   $0x801bc4,(%esp)
  80140c:	e8 5f ff ff ff       	call   801370 <_panic>
		//然后设置一下入口为_pgfault_upcall
		if(sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  801411:	c7 44 24 04 4f 14 80 	movl   $0x80144f,0x4(%esp)
  801418:	00 
  801419:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801420:	e8 21 fa ff ff       	call   800e46 <sys_env_set_pgfault_upcall>
  801425:	85 c0                	test   %eax,%eax
  801427:	79 1c                	jns    801445 <set_pgfault_handler+0x7f>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall failed");
  801429:	c7 44 24 08 8c 1b 80 	movl   $0x801b8c,0x8(%esp)
  801430:	00 
  801431:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  801438:	00 
  801439:	c7 04 24 c4 1b 80 00 	movl   $0x801bc4,(%esp)
  801440:	e8 2b ff ff ff       	call   801370 <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  801445:	8b 45 08             	mov    0x8(%ebp),%eax
  801448:	a3 08 20 80 00       	mov    %eax,0x802008
}
  80144d:	c9                   	leave  
  80144e:	c3                   	ret    

0080144f <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  801450:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  80145a:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)  //原本的esp-4，用于ret
  80145e:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx  //获得扩大后的原本的esp
  801463:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)      //填充ret地址
  801467:	89 03                	mov    %eax,(%ebx)
  ...
  801471:	5c                   	pop    %esp
	...
	ret
  801472:	c3                   	ret    
  801473:	66 90                	xchg   %ax,%ax
  801475:	66 90                	xchg   %ax,%ax
  801477:	66 90                	xchg   %ax,%ax
