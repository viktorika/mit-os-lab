...
exit(void)
{
  ...
  800089:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80008c:	e8 65 05 00 00       	call   8005f6 <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800109:	00 
  80010a:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  800111:	00 
  800112:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800119:	00 
  80011a:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  800121:	e8 60 10 00 00       	call   801186 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019b:	00 
  80019c:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  8001a3:	00 
  8001a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ab:	00 
  8001ac:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8001b3:	e8 ce 0f 00 00       	call   801186 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ee:	00 
  8001ef:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  8001f6:	00 
  8001f7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fe:	00 
  8001ff:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  800206:	e8 7b 0f 00 00       	call   801186 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800241:	00 
  800242:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  800249:	00 
  80024a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800251:	00 
  800252:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  800259:	e8 28 0f 00 00       	call   801186 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800294:	00 
  800295:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  80029c:	00 
  80029d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a4:	00 
  8002a5:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8002ac:	e8 d5 0e 00 00       	call   801186 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e7:	00 
  8002e8:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  8002ef:	00 
  8002f0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f7:	00 
  8002f8:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8002ff:	e8 82 0e 00 00       	call   801186 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033a:	00 
  80033b:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  800342:	00 
  800343:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034a:	00 
  80034b:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  800352:	e8 2f 0e 00 00       	call   801186 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003af:	00 
  8003b0:	c7 44 24 08 8a 20 80 	movl   $0x80208a,0x8(%esp)
  8003b7:	00 
  8003b8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bf:	00 
  8003c0:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
  8003c7:	e8 ba 0d 00 00       	call   801186 <_panic>
...
00800542 <fd_close>:
{
  ...
  8005b5:	e8 59 fc ff ff       	call   800213 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8006b3:	e8 08 fb ff ff       	call   8001c0 <sys_page_map>
  ...
  8006ee:	e8 cd fa ff ff       	call   8001c0 <sys_page_map>
...
err:
  ...
  800707:	e8 07 fb ff ff       	call   800213 <sys_page_unmap>
	sys_page_unmap(0, nva);
  80070c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800710:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800717:	e8 f7 fa ff ff       	call   800213 <sys_page_unmap>
	return r;
...
devpipe_close(struct Fd *fd)
{
  ...
  800c88:	e8 86 f5 ff ff       	call   800213 <sys_page_unmap>
  ...
  800ca0:	e8 6e f5 ff ff       	call   800213 <sys_page_unmap>
}
...
00800d14 <devpipe_write>:
{
  ...
  800d42:	75 54                	jne    800d98 <devpipe_write+0x84>
			sys_yield();
  800d44:	e8 04 f4 ff ff       	call   80014d <sys_yield>
...
00800da5 <devpipe_read>:
{
  ...
  800dd7:	75 43                	jne    800e1c <devpipe_read+0x77>
			sys_yield();
  800dd9:	e8 6f f3 ff ff       	call   80014d <sys_yield>
...
00800e29 <pipe>:
{
  ...
  800e5c:	e8 0b f3 ff ff       	call   80016c <sys_page_alloc>
  ...
  800e96:	e8 d1 f2 ff ff       	call   80016c <sys_page_alloc>
  ...
  800ec5:	e8 a2 f2 ff ff       	call   80016c <sys_page_alloc>
  ...
  800efe:	e8 bd f2 ff ff       	call   8001c0 <sys_page_map>
...
00800ffa <devcons_write>:
{
  ...
  801046:	e8 54 f0 ff ff       	call   80009f <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801068 <devcons_read>:
{
  ...
  801079:	eb 28                	jmp    8010a3 <devcons_read+0x3b>
		sys_yield();
  80107b:	e8 cd f0 ff ff       	call   80014d <sys_yield>
	while ((c = sys_cgetc()) == 0)
  801080:	e8 38 f0 ff ff       	call   8000bd <sys_cgetc>
...
008010a5 <cputchar>:
{
  ...
  8010bf:	e8 db ef ff ff       	call   80009f <sys_cputs>
}
  8010c4:	c9                   	leave  
  8010c5:	c3                   	ret    
...
0080112b <opencons>:
{
  ...
  801158:	e8 0f f0 ff ff       	call   80016c <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801197:	e8 92 ef ff ff       	call   80012e <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801209:	e8 91 ee ff ff       	call   80009f <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801272:	e8 28 ee ff ff       	call   80009f <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801cd0:	e8 ad e6 ff ff       	call   800382 <sys_ipc_recv>
	if(from_env_store)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d33:	75 05                	jne    801d3a <ipc_send+0x22>
			//失败到一定次数后放弃CPU
			sys_yield();
  801d35:	e8 13 e4 ff ff       	call   80014d <sys_yield>
	while(sys_ipc_try_send(to_env, val, pg, perm) < 0){
  ...
  801d4f:	e8 0b e6 ff ff       	call   80035f <sys_ipc_try_send>
