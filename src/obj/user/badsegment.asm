...
sys_ipc_recv(void *dstva)
{
  ...
  800357:	00 
  800358:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  80035f:	00 
  800360:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800367:	00 
  800368:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003a8:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
  ...
  8003be:	e8 51 00 00 00       	call   800414 <vcprintf>
	cprintf("\n");
  8003c3:	c7 04 24 9c 11 80 00 	movl   $0x80119c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800450:	e8 af 01 00 00       	call   800604 <vprintfmt>
	sys_cputs(b.buf, b.idx);
