	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024e:	0f be 80 88 11 80 00 	movsbl 0x801188(%eax),%eax
...
008002e4 <vprintfmt>:
{
  ...
  80036c:	ff 24 85 40 12 80 00 	jmp    *0x801240(,%eax,4)
  ...
  80044e:	c7 44 24 08 a9 11 80 	movl   $0x8011a9,0x8(%esp)
  800455:	00 
  ...
  80047d:	ba 99 11 80 00       	mov    $0x801199,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf6:	00 
  800bf7:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800bfe:	00 
  800bff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c06:	00 
  800c07:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c88:	00 
  800c89:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800c90:	00 
  800c91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c98:	00 
  800c99:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cdb:	00 
  800cdc:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800ce3:	00 
  800ce4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ceb:	00 
  800cec:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d2e:	00 
  800d2f:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800d36:	00 
  800d37:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3e:	00 
  800d3f:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d81:	00 
  800d82:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800d89:	00 
  800d8a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d91:	00 
  800d92:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dd4:	00 
  800dd5:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800ddc:	00 
  800ddd:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de4:	00 
  800de5:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e49:	00 
  800e4a:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800e51:	00 
  800e52:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e59:	00 
  800e5a:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e9a:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  ...
  800eb0:	e8 39 f2 ff ff       	call   8000ee <vcprintf>
	cprintf("\n");
  800eb5:	c7 04 24 7c 11 80 00 	movl   $0x80117c,(%esp)
