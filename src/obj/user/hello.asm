...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 a0 20 80 00 	movl   $0x8020a0,(%esp)
  ...
  800051:	c7 04 24 ae 20 80 00 	movl   $0x8020ae,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80006d:	e8 b9 0b 00 00       	call   800c2b <sys_getenvid>
...
exit(void)
{
  ...
  8000aa:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ad:	e8 44 10 00 00       	call   8010f6 <close_all>
	sys_env_destroy(0);
  8000b2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b9:	e8 1b 0b 00 00       	call   800bd9 <sys_env_destroy>
}
  8000be:	c9                   	leave  
  8000bf:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000ed:	e8 aa 0a 00 00       	call   800b9c <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80013e:	e8 b1 01 00 00       	call   8002f4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800156:	e8 41 0a 00 00       	call   800b9c <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025e:	0f be 80 cf 20 80 00 	movsbl 0x8020cf(%eax),%eax
...
008002f4 <vprintfmt>:
{
  ...
  80045e:	c7 44 24 08 9f 24 80 	movl   $0x80249f,0x8(%esp)
  800465:	00 
  ...
  80048d:	ba e0 20 80 00       	mov    $0x8020e0,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c06:	00 
  800c07:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800c0e:	00 
  800c0f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c16:	00 
  800c17:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c98:	00 
  800c99:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800ca0:	00 
  800ca1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca8:	00 
  800ca9:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ceb:	00 
  800cec:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800cf3:	00 
  800cf4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cfb:	00 
  800cfc:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d3e:	00 
  800d3f:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800d46:	00 
  800d47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d4e:	00 
  800d4f:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d91:	00 
  800d92:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800d99:	00 
  800d9a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da1:	00 
  800da2:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800de4:	00 
  800de5:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800dec:	00 
  800ded:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df4:	00 
  800df5:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e37:	00 
  800e38:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800e3f:	00 
  800e40:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e47:	00 
  800e48:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800eac:	00 
  800ead:	c7 44 24 08 df 23 80 	movl   $0x8023df,0x8(%esp)
  800eb4:	00 
  800eb5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ebc:	00 
  800ebd:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801014:	8b 15 04 40 80 00    	mov    0x804004,%edx
  80101a:	8b 52 48             	mov    0x48(%edx),%edx
  80101d:	89 44 24 08          	mov    %eax,0x8(%esp)
  801021:	89 54 24 04          	mov    %edx,0x4(%esp)
  801025:	c7 04 24 0c 24 80 00 	movl   $0x80240c,(%esp)
  80102c:	e8 32 f1 ff ff       	call   800163 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80127b:	c7 04 24 4d 24 80 00 	movl   $0x80244d,(%esp)
  801282:	e8 dc ee ff ff       	call   800163 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801363:	c7 04 24 69 24 80 00 	movl   $0x802469,(%esp)
  80136a:	e8 f4 ed ff ff       	call   800163 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80141c:	c7 04 24 2c 24 80 00 	movl   $0x80242c,(%esp)
  801423:	e8 3b ed ff ff       	call   800163 <cprintf>
		return -E_INVAL;
...
008015f2 <devfile_read>:
{
  ...
  801627:	c7 44 24 0c 86 24 80 	movl   $0x802486,0xc(%esp)
  80162e:	00 
  80162f:	c7 44 24 08 8d 24 80 	movl   $0x80248d,0x8(%esp)
  801636:	00 
  801637:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  80163e:	00 
  80163f:	c7 04 24 a2 24 80 00 	movl   $0x8024a2,(%esp)
  801646:	e8 3b 06 00 00       	call   801c86 <_panic>
	assert(r <= PGSIZE);
  80164b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801650:	7e 24                	jle    801676 <devfile_read+0x84>
  801652:	c7 44 24 0c ad 24 80 	movl   $0x8024ad,0xc(%esp)
  801659:	00 
  80165a:	c7 44 24 08 8d 24 80 	movl   $0x80248d,0x8(%esp)
  801661:	00 
  801662:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  801669:	00 
  80166a:	c7 04 24 a2 24 80 00 	movl   $0x8024a2,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801738:	c7 44 24 04 b9 24 80 	movl   $0x8024b9,0x4(%esp)
  80173f:	00 
...
008017ab <_pipeisclosed>:
{
  ...
  8017b6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
		n = thisenv->env_runs;
  8017b9:	a1 04 40 80 00       	mov    0x804004,%eax
  ...
  8017db:	0f b6 c2             	movzbl %dl,%eax
		nn = thisenv->env_runs;
  8017de:	8b 0d 04 40 80 00    	mov    0x804004,%ecx
  ...
  8017fe:	c7 04 24 c0 24 80 00 	movl   $0x8024c0,(%esp)
  801805:	e8 59 e9 ff ff       	call   800163 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ae0:	c7 44 24 04 d8 24 80 	movl   $0x8024d8,0x4(%esp)
  801ae7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801cb2:	c7 04 24 e4 24 80 00 	movl   $0x8024e4,(%esp)
  801cb9:	e8 a5 e4 ff ff       	call   800163 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801cbe:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801cc2:	8b 45 10             	mov    0x10(%ebp),%eax
  801cc5:	89 04 24             	mov    %eax,(%esp)
  801cc8:	e8 35 e4 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  801ccd:	c7 04 24 d1 24 80 00 	movl   $0x8024d1,(%esp)
  801cd4:	e8 8a e4 ff ff       	call   800163 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d02:	8b 15 04 40 80 00    	mov    0x804004,%edx
