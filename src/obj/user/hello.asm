...
umain(int argc, char **argv)
{
  ...
  800051:	c7 04 24 8e 11 80 00 	movl   $0x80118e,(%esp)
...
exit(void)
{
  ...
  8000b4:	e8 20 0b 00 00       	call   800bd9 <sys_env_destroy>
}
  8000b9:	c9                   	leave  
  8000ba:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000e8:	e8 af 0a 00 00       	call   800b9c <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800139:	e8 b6 01 00 00       	call   8002f4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800151:	e8 46 0a 00 00       	call   800b9c <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025e:	0f be 80 af 11 80 00 	movsbl 0x8011af(%eax),%eax
...
008002f4 <vprintfmt>:
{
  ...
  80037c:	ff 24 85 80 12 80 00 	jmp    *0x801280(,%eax,4)
  ...
  80045e:	c7 44 24 08 d0 11 80 	movl   $0x8011d0,0x8(%esp)
  800465:	00 
  ...
  80048d:	ba c0 11 80 00       	mov    $0x8011c0,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c06:	00 
  800c07:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800c0e:	00 
  800c0f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c16:	00 
  800c17:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c98:	00 
  800c99:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800ca0:	00 
  800ca1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca8:	00 
  800ca9:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ceb:	00 
  800cec:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800cf3:	00 
  800cf4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cfb:	00 
  800cfc:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d3e:	00 
  800d3f:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800d46:	00 
  800d47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d4e:	00 
  800d4f:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d91:	00 
  800d92:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800d99:	00 
  800d9a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da1:	00 
  800da2:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800de4:	00 
  800de5:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800dec:	00 
  800ded:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df4:	00 
  800df5:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e59:	00 
  800e5a:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800e61:	00 
  800e62:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e69:	00 
  800e6a:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800eaa:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  800eb1:	e8 a8 f2 ff ff       	call   80015e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800eb6:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800eba:	8b 45 10             	mov    0x10(%ebp),%eax
  800ebd:	89 04 24             	mov    %eax,(%esp)
  800ec0:	e8 38 f2 ff ff       	call   8000fd <vcprintf>
	cprintf("\n");
  800ec5:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
  800ecc:	e8 8d f2 ff ff       	call   80015e <cprintf>
